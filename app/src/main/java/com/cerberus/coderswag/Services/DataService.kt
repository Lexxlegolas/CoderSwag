package com.cerberus.coderswag.Services

import com.cerberus.coderswag.Model.Category
import com.cerberus.coderswag.Model.Product
...
object DataService
{
    ...
    val hoodies = listOf(
            ...
            Product("Devslopes Gray Black","32$","hoodie4")
    ...
    val shirts = listOf(
            ...
            Product("Kick Flip Studios","20$","shirt5")
    )
}